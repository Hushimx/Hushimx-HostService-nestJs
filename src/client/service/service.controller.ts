...
export class ServiceController {
  ...
  async getServiceOrderDetails(@Param('id') orderId: string, @GetUser() client) {
    return this.serviceService.getServiceOrderDetails(orderId, client.clientId);
  }
  ...
  async placeServiceOrder(@Body() dto: PlaceServiceOrderDto, @GetUser() client: any) {
